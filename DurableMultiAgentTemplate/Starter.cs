...
/// Offers synchronous and asynchronous HTTP triggers to start agent orchestration.
/// </summary>
public class Starter(ILogger<Starter> logger)
{
    ...
    /// <summary>
    /// HTTP trigger function that synchronously executes agent orchestration and waits for completion.
    /// </summary>
    ...
    /// <summary>
    /// HTTP trigger function that asynchronously starts agent orchestration.
    /// </summary>
    /// <param name="req">HTTP request data</param>
    /// <param name="client">Durable task client</param>
    ...
    /// <summary>
    /// Helper method to extract agent request data from HTTP request.
    /// </summary>
    /// <param name="req">HTTP request data</param>
    /// <returns>Agent request data, or null if request is invalid</returns>
